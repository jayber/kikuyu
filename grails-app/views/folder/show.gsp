...
<body>
<a href="#show-folder" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
<div id="show-folder" class="content scaffold-show" role="main">
    ...
    <ol class="property-list folder">
        ...
        <g:if test="${folderInstance?.name}">
            <li class="fieldcontain">
                ...
                <span class="property-value" aria-labelledby="name-label"><g:fieldValue bean="${folderInstance}"
                                                                                        field="name"/></span>
    ...
    <g:form>
        <fieldset class="buttons">
            <g:hiddenField name="id" value="${folderInstance?.id}"/>
            <g:link class="edit" action="edit" id="${folderInstance?.id}"><g:message code="default.button.edit.label"
                                                                                     default="Edit"/></g:link>
